...
annotate("Celebrity ad", xy=(214, medianBO[122]+2), xytext=(214.01,
	medianBO[122]+46), textcoords='data', arrowprops=dict(facecolor='darkblue',
	edgecolor='darkblue', shrink=0.08, width=0.5, headwidth=4),
	horizontalalignment='center', verticalalignment='top', fontsize=12)
annotate("McCain\nhouses\ngaffe", xy=(234, medianBO[142]-4), xytext=(234.01,
	medianBO[142]-41), textcoords='data', arrowprops=dict(facecolor='darkblue',
	edgecolor='darkblue', shrink=0.075, width=0.5, headwidth=4),
	horizontalalignment='center', verticalalignment='top', fontsize=12)
annotate("DNC", xy=(238, medianBO[146]-6), xytext=(238.01,
	medianBO[146]-25), textcoords='data', arrowprops=dict(facecolor='darkblue',
	edgecolor='darkblue', shrink=0.075, width=0.5, headwidth=4),
	horizontalalignment='left', verticalalignment='top', fontsize=12)
annotate("RNC", xy=(246, medianBO[154]+8), xytext=(246.01,
	medianBO[154]+48), textcoords='data', arrowprops=dict(facecolor='darkblue',
	edgecolor='darkblue', shrink=0.075, width=0.5, headwidth=4),
	horizontalalignment='left', verticalalignment='top', fontsize=12)
...
show()
savefig(open('special-EV_history.png', 'w'), dpi=62.5, facecolor='#fcfcf4',
		edgecolor='#fcfcf4')

show()
savefig(open('special-EV_history-full_size.png', 'w'), facecolor='#fcfcf4',
		edgecolor='#fcfcf4')
