...
evdisplay.write('\t<li style="float: center; clear: both; padding-top: 0px;"><a href="http://election.princeton.edu/2012/10/27/landfall/">Probability of Obama re-election: Random Drift %s%%, Prediction %s%%</a></li>\n' % (drift_win_prob, bayesian_win_prob))
